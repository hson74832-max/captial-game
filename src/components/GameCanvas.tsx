      ...
      {hoveredMapTile && (
        <div className="pointer-events-none absolute bottom-4 left-4 min-w-56 rounded-lg border border-slate-700 bg-slate-950/88 px-3 py-2 text-[10px] text-slate-300 shadow-xl backdrop-blur-sm">
          ...
          <div className="mt-1 grid grid-cols-2 gap-x-4 gap-y-0.5">
            ...
            {hoveredMapTile.highway && (
              <><span className="text-slate-500">Interstate</span><span className="text-right text-yellow-400">Highway right-of-way</span></>
            )}
            {!hoveredMapTile.highway && (
              <><span className="text-slate-500">Zoning</span><span className="text-right capitalize text-slate-200">{hoveredMapTile.zone}</span></>
            )}
          </div>
