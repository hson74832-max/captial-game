...
// ============= STATE INDEX =============
// Hot simulation loops previously used repeated Array.find / Array.filter, which is
// O(n) per lookup and O(n^2) overall. This module builds O(1) maps plus a uniform
